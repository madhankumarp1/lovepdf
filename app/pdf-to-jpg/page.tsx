...
export default function PdfToJpgPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            // In a real app, we would send the file to backend and get images back.
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                {files.length > 0 && (
                    <div className="mt-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4">
                        <div className="flex items-center gap-4 p-4 bg-yellow-50 rounded-xl mb-6 w-full max-w-md">
                        ...
                        <button
                            ...
                            disabled={processing}
                            className="flex items-center justify-center gap-2 bg-yellow-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-yellow-200 min-w-[200px]"
                        >
                            {processing ? (
                                <>
